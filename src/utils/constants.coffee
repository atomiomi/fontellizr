arrayToHash = (items) ->
  hash = {}
  hash[item] = true for item in items
  hash
...
UNICODE_PRIVATE_USE_AREA_MIN = 0xE800
UNICODE_PRIVATE_USE_AREA_MAX = 0xF8FF

RESTRICTED_BLOCK_MIN = 0xD800
RESTRICTED_BLOCK_MAX = 0xDFFF
RESTRICTED_SINGLE_CODES = arrayToHash([
